...
public class ViewMpsController implements Initializable{
	    ...
	    @FXML
	    private BorderPane borderLayou;

	    @FXML
	    private Pane centerPanel;

	    @FXML
	    private GridPane gpCenterPanel;
	    ...
	    @FXML
	    private TextField tfGrossRequeriment;

	    @FXML
	    private TextField tfScheduledReceptions;

	    @FXML
	    private Pane topPanel;

	    @FXML
	    private Label labMpsTittle;
	    ...
	    void pressendButAddTime(ActionEvent event) {
	    	...
	    	Label newTime = new Label("T = "+(textFRequest.size()+2));
